...
public class ColoredRatingBar extends View {
    ...
    private void init(Context context) {
        ...
        if (mType == SMALL) {
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_orange_small), BitmapFactory.decodeResource(res, R.drawable.star_orange_small), BitmapFactory.decodeResource(res, R.drawable.star_orange_small)};
            progressBackground = BitmapFactory.decodeResource(res, R.drawable.star_black_small);
        } else {
            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_orange), BitmapFactory.decodeResource(res, R.drawable.star_orange), BitmapFactory.decodeResource(res, R.drawable.star_orange)};
...
//                    croppedBmp.recycle();
                ...
                if (bgWidth > 0) {
                    ...
                    canvas.drawBitmap(croppedBg, (position * sourceWidth) + (float) targetWidth, 0, null);
//                    croppedBg.recycle();
                }
            } else {
    ...
    private float getRelativePosition(float x) {
        ...
        return Math.min(position, mNumStars - 1f);
    }
